...
public class SwaggerConfiguration {
    public static final String BASE_PACKAGE = "com.nepxion.discovery.platform.server.controller";

    @Value("${spring.application.name}")
    private String serviceName;

    @Value("${swagger.service.description:Platform Restful APIs}")
    ...
    @Value("${swagger.service.contact.url:https://github.com/Nepxion/DiscoveryPlatform}")
