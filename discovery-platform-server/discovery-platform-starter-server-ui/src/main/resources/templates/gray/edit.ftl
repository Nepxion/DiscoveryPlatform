        ...
        <div class="layui-form-item">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input disabled="disabled" type="radio" lay-filter="portalType" name="portalType" value="1" title="网关" ${(entity.portalType==1)?string('checked','')}>
                    <input disabled="disabled" type="radio" lay-filter="portalType" name="portalType" value="2" title="服务" ${(entity.portalType==2)?string('checked','')}>
                    <input disabled="disabled" type="radio" lay-filter="portalType" name="portalType" value="3" title="组" ${(entity.portalType==3)?string('checked','')}>
                </div>
            </div>

            <label class="layui-form-label">入口名称</label>
            <div class="layui-input-inline" style="width: 850px">
                <select id="portalName" disabled="disabled" name="portalName" lay-filter="portalName" lay-verify="required" lay-search>
                </select>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 850px;margin-top: 15px">
                    <input type="text" name="description" value="${entity.description}" class="layui-input" placeholder="请输入该${((type!'')=='VERSION')?string('版本','区域')}灰度的描述信息" autocomplete="off">
                </div>
            </div>
