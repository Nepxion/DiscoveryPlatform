...
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 2001, '链路编排', '/route/list', '1', '0', '0', '', 20, 1, '蓝绿发布' where not exists (select * from sys_menu where id = 2001);
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 2002, '蓝绿发布', '/blue-green/list', '1', '0', '0', '', 20, 2, '蓝绿发布' where not exists (select * from sys_menu where id = 2002);
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 2003, '灰度发布', '/gray/list', '1', '0', '0', '', 20, 3, '灰度发布' where not exists (select * from sys_menu where id = 2003);
