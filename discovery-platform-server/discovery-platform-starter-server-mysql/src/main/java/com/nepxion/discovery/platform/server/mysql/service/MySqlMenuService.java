...
import com.nepxion.discovery.platform.server.mysql.mapper.MySqlMenuMapper;
import com.nepxion.discovery.platform.server.service.MenuService;
import com.nepxion.discovery.platform.server.tool.CommonTool;

public class MySqlMenuService extends ServiceImpl<MySqlMenuMapper, SysMenuDto> implements MenuService {
    @TransactionReader
    @Override
