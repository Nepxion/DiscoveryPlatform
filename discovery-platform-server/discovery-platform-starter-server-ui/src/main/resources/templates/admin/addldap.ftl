<@compress single_line=true>
    ...
    <div class="layui-form" lay-filter="layuiadmin-form-admin" id="layuiadmin-form-admin"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width: 700px">
                <input type="text" id="username" name="username" lay-verify="required" autocomplete="off"
                       style="width: 740px" placeholder="请填写账号名进行搜索" class="layui-input">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="phoneNumber" name="phoneNumber" lay-verify="phone" style="width: 740px"
                       class="layui-input layui-disabled" readonly>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="email" name="email" value="" lay-verify="email" style="width: 740px"
                       class="layui-input layui-disabled" readonly>
            </div>
        </div>
