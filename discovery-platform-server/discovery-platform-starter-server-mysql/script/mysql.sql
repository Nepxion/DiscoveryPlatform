...
INSERT IGNORE INTO `sys_page`(`id`, `name`, `url`, `is_menu`, `is_default`, `is_blank`, `icon_class`, `parent_id`, `order`, `remark`) VALUES (1, '灰度发布', '/gray/list', b'1', b'1', b'0', 'layui-icon-release', 0, 1, '动态灰度发布');
...
INSERT IGNORE INTO `sys_page`(`id`, `name`, `url`, `is_menu`, `is_default`, `is_blank`, `icon_class`, `parent_id`, `order`, `remark`) VALUES (3, 'Gateway网关', '/routegateway/list', b'1', b'0', b'0', 'layui-icon-website', 2, 1, 'Gateway动态路由配置');
INSERT IGNORE INTO `sys_page`(`id`, `name`, `url`, `is_menu`, `is_default`, `is_blank`, `icon_class`, `parent_id`, `order`, `remark`) VALUES (4, 'Zuul网关', '/routezuul/list', b'1', b'0', b'0', 'layui-icon-website', 2, 2, 'Zuul动态路由配置');
...
INSERT IGNORE INTO `sys_page`(`id`, `name`, `url`, `is_menu`, `is_default`, `is_blank`, `icon_class`, `parent_id`, `order`, `remark`) VALUES (6, '接口列表', '/api/list', b'1', b'0', b'0', '', 5, 1, '接口列表');
INSERT IGNORE INTO `sys_page`(`id`, `name`, `url`, `is_menu`, `is_default`, `is_blank`, `icon_class`, `parent_id`, `order`, `remark`) VALUES (7, '应用列表', '/app/list', b'1', b'0', b'0', '', 5, 2, '应用列表');
...
INSERT IGNORE INTO `sys_page`(`id`, `name`, `url`, `is_menu`, `is_default`, `is_blank`, `icon_class`, `parent_id`, `order`, `remark`) VALUES (16, '注册中心管理', '/consul/list', b'1', b'0', b'0', '', 15, 1, '注册中心管理');
...
INSERT IGNORE INTO `sys_page`(`id`, `name`, `url`, `is_menu`, `is_default`, `is_blank`, `icon_class`, `parent_id`, `order`, `remark`) VALUES (18, '页面配置', '/page/list', b'1', b'0', b'0', '', 17, 1, '页面配置');
...
INSERT IGNORE INTO `sys_page`(`id`, `name`, `url`, `is_menu`, `is_default`, `is_blank`, `icon_class`, `parent_id`, `order`, `remark`) VALUES (20, '管理员配置', '/admin/list', b'1', b'0', b'0', '', 19, 1, '管理员配置');
INSERT IGNORE INTO `sys_page`(`id`, `name`, `url`, `is_menu`, `is_default`, `is_blank`, `icon_class`, `parent_id`, `order`, `remark`) VALUES (21, '角色管理', '/role/list', b'1', b'0', b'0', '', 19, 2, '角色管理');
INSERT IGNORE INTO `sys_page`(`id`, `name`, `url`, `is_menu`, `is_default`, `is_blank`, `icon_class`, `parent_id`, `order`, `remark`) VALUES (22, '权限管理', '/permission/list', b'1', b'0', b'0', '', 19, 3, '权限管理');
