...
import com.nepxion.discovery.platform.server.ui.interfaces.RouteGatewayService;
...
//        return Result.ok(workingVoList);
    ...
    public Result<?> publish() throws Exception {
        ...
        if (CollectionUtils.isEmpty(gatewayNames)) {
            return Result.error("No gateway instances were found, please confirm that the gateway is started");
        }
