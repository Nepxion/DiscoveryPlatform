...
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 2001, '链路编排', '/route-arrange/list', '1', '0', '0', '', 20, 1, '链路编排' where not exists (select * from sys_menu where id = 2001);
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 2002, '蓝绿灰度', '/strategy/list', '1', '0', '0', '', 20, 2, '蓝绿灰度' where not exists (select * from sys_menu where id = 2002);
