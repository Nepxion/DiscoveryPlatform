...
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 2, '实例管理', '', '1', '0', '0', 'layui-icon-template-1', 0, 3, '实例管理' where not exists (select * from sys_menu where id = 2);
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 201, '实例摘除', '/blacklist/list', '1', '0', '0', '', 2, 1, '实例摘除' where not exists (select * from sys_menu where id = 201);

INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 3, '路由配置', '', '1', '0', '0', 'layui-icon-website', 0, 4, '路由配置' where not exists (select * from sys_menu where id = 3);
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 301, 'Gateway网关路由', '/route-gateway/list', '1', '0', '0', '', 3, 1, 'Spring Cloud Gateway路由配置' where not exists (select * from sys_menu where id = 301);
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 302, 'Zuul网关路由', '/route-zuul/list', '1', '0', '0', '', 3, 2, 'Zuul路由配置' where not exists (select * from sys_menu where id = 302);
...
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 9, '低代码平台', '', '1', '0', '0', 'layui-icon-template', 0, 10, '低代码平台' where not exists (select * from sys_menu where id = 9);
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 901, '脚手架创建', '/skeleton/add', '1', '0', '0', '', 9, 1, '脚手架创建' where not exists (select * from sys_menu where id = 901);
