...
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 1, '服务发布', '', '1', '0', '0', 'layui-icon-release', 0, 2, '服务发布' where not exists (select * from sys_menu where id = 12);
...
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 10, '告警管理', '', '1', '0', '0', 'layui-icon-about', 0, 11, '告警管理' where not exists (select * from sys_menu where id = 10);
