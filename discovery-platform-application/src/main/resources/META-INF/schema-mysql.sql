...
CREATE TABLE IF NOT EXISTS `t_gray`  (
    ...
    `strategy`                  TEXT                            NOT NULL COMMENT '灰度发布兜底服务编排',
    `condition`                 TEXT                            NOT NULL COMMENT '灰度发布条件编排',
    `route`                     TEXT                            NOT NULL COMMENT '灰度发布服务编排',
...
INSERT IGNORE INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) VALUES (2001, '蓝绿发布', '/blue-green/list', b'1', b'0', b'0', '', 20, 1, '蓝绿发布');
INSERT IGNORE INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) VALUES (2002, '灰度发布', '/gray/list', b'1', b'0', b'0', '', 20, 2, '灰度发布');
