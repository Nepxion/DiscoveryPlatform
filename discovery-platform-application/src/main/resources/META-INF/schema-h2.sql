...
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 3001, '实例摘除', '/blacklist/list', '1', '0', '0', '', 30, 1, '实例摘除' where not exists (select * from sys_menu where id = 3001);
