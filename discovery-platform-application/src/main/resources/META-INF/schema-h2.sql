...
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 5, '告警管理', '', '1', '0', '0', 'layui-icon-about', 0, 6, '告警管理' where not exists (select * from sys_menu where id = 5);
...
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 6, '注册中心', '', '1', '0', '0', 'layui-icon-flag', 0, 7, '注册中心' where not exists (select * from sys_menu where id = 6);
...
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 7, '配置中心', '', '1', '0', '0', 'layui-icon-component', 0, 8, '配置中心' where not exists (select * from sys_menu where id = 7);
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 701, 'Apollo', 'http://106.54.227.205/', '1', '0', '1', '', 7, 1, 'Apollo配置中心' where not exists (select * from sys_menu where id = 701);

INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 8, '监控中心', '', '1', '0', '0', 'layui-icon-app', 0, 9, '监控中心' where not exists (select * from sys_menu where id = 8);
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 801, 'Spring Boot Admin', 'http://127.0.0.1:6002', '1', '0', '1', '', 8, 1, 'Spring Boot Admin监控中心' where not exists (select * from sys_menu where id = 801);
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 802, 'Grafana', 'http://127.0.0.1:3000', '1', '0', '1', '', 8, 2, 'Grafana监控中心' where not exists (select * from sys_menu where id = 802);
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 803, 'SkyWalking', 'http://127.0.0.1:8080', '1', '0', '1', '', 8, 3, 'SkyWalking监控中心' where not exists (select * from sys_menu where id = 803);

INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 9, '限流中心', '', '1', '0', '0', 'layui-icon-transfer', 0, 10, '限流中心' where not exists (select * from sys_menu where id = 9);
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 901, 'Sentinel', 'http://127.0.0.1:8075', '1', '0', '1', '', 9, 1, 'Sentinel限流中心' where not exists (select * from sys_menu where id = 901);

INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 10, '日志中心', '', '1', '0', '0', 'layui-icon-form', 0, 11, '日志中心' where not exists (select * from sys_menu where id = 10);
INSERT INTO `sys_menu`(`id`, `name`, `url`, `show_flag`, `default_flag`, `blank_flag`, `icon_class`, `parent_id`, `order`, `description`) SELECT 1001, 'Kibana', 'http://127.0.0.1:5601 ', '1', '0', '1', '', 10, 1, 'Kibana日志中心' where not exists (select * from sys_menu where id = 1001);
